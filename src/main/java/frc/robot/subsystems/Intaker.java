...
public class Intaker implements Subsystem, Updatable {
    ...
    private Intaker() {
        ...
        // Soft PID
        deploy.config_kP(0, Constants.IntakerConstants.DEPLOY_SOFT_KP.get());
        deploy.config_kI(0, Constants.IntakerConstants.DEPLOY_SOFT_KI.get());
        deploy.config_kD(0, Constants.IntakerConstants.DEPLOY_SOFT_KD.get());
        ...
        if (Constants.TUNING) {
            dataTab = Shuffleboard.getTab(this.getClass().getName());
